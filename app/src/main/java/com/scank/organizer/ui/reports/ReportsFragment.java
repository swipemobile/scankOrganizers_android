package com.scank.organizer.ui.reports;
...
public class ReportsFragment extends Fragment {
    ...
    public ReportsFragment(EventData eventData) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dashboardViewModel = new ViewModelProvider(this).get(ReportViewModel.class);
    ...
    public void setListener() {
        ...
        webView.loadUrl(eventData.getReportUrl());
